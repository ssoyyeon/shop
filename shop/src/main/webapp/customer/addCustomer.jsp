			...
			<div class="row">
				<div class="col-lg-12"
					...
					<div>
						...
						<button type="button" id="idCkCustomerBtn" class="btn"
							style="float: right; background-color: black; color: white; margin-top: 1%;">check</button>
						<br>
					</div>
					...
					<form class="form-group" id="addCustomerForm" method="post"
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id="customer_pass"
								placeholder="Please enter Your Password" name="customer_pass">
						</div>
						<div class="form-group">
							<label for="customer_name" style="float: left">CustomerName</label>
							<input type="text" class="form-control" id="customer_name"
								name="customer_name" placeholder="Please enter Your Name">
						</div>
						<div class="form-group">
							<label for="customer_telephone" style="float: left">CustomerTelephone</label>
						...
						<div class="form-group">
							...
							<input type="button" onclick="sample2_execDaumPostcode()"
								...
								style="margin-right: 90%; margin-top:2%; background-color: black; color: white"><br>
						...
						<button type="button" class="btn" id="addBtn"
							style="float: right; background-color: black; color: white; margin top: 3%; margin-bottom: 2%;">join</button>
					</form>
				</div>
			</div>
		</div>
