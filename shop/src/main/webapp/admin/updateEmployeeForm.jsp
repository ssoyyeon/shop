...
%>
				<a
					href="<%=request.getContextPath()%>/admin/updateEmployeeForm.jsp?currentPage=<%=currentPage - 1%>">
...
%>
				<a href="<%=request.getContextPath()%>/admin/updateEmployeeForm.jsp?currentPage=<%=currentPage - 1%>">
...
%>				
				<a
				href="<%=request.getContextPath()%>/admin/updateEmployeeForm.jsp?currentPage=<%=currentPage%>">
