	...
	<div class="row">
		...
		<div class="col-lg-12"
			...
			<form
				...
				id="addGoodsForm" method="post" enctype="multipart/form-data"
				class="form-group">
				<hr>
				<br> <br>
				<table class="table table-hover table-striped">
					<tr>
						...
						<td><input type="text" name="goodsNo" id="goodsNo"
							class="form-control" value="<%=goodsNo%>" readonly></td>
					</tr>
					<tr>
						...
						<td><img alt="이미지 파일"
							...
							width=200; height=200; style="background-color: white;"><input
							type="hidden" name="originFilename"
							value="<%=map.get("goodsName")%>"></td>
					</tr>
					<tr>
						<td><label for="goodsName"><b>GoodsName</b></label></td>
						<td><input type="text" name="goodsName" id="goodsName"
							class="form-control" value="<%=map.get("goodsName")%>"></td>
					</tr>
					<tr>
						<td><label for="goodsPrice"><b>GoodsPrice</b></label></td>
						<td><input type="text" name="goodsPrice" id="goodsPrice"
							class="form-control" value="<%=map.get("goodsPrice")%>"></td>
					</tr>
					<tr>
						<td><label for="soldOut"><b>SoldOut</b></label></td>
						<td><input type="text" name="soldOut" id="soldOut"
							class="form-control" value="<%=map.get("soldOut")%>"></td>
					</tr>

				</table>
				<br> <br>
				<button type="submit" class="btn"
					style="color: white; background-color: black; float: right; margin-right: 3%; margin-bottom: 5%;">Modify</button>
			</form>
		</div>
	</div>
</div>
